# 1 "c:\\Users\\GOOD\\Nextcloud\\final_project_ultrasonic_speedometer\\final_project_ultrasonic_speedometer.ino"
...
# 6 "c:\\Users\\GOOD\\Nextcloud\\final_project_ultrasonic_speedometer\\final_project_ultrasonic_speedometer.ino" 2
# 7 "c:\\Users\\GOOD\\Nextcloud\\final_project_ultrasonic_speedometer\\final_project_ultrasonic_speedometer.ino" 2
...
Adafruit_NeoPixel np = Adafruit_NeoPixel(56, 10, ((1 << 6) | (1 << 4) | (0 << 2) | (2)) /*|< Transmit as G,R,B*/ + 0x0000 /*|< 800 KHz data transmission*/);
...
void loop()
{
 int distance_1 = urm07GetDistance(0x13);
  delay(1000);
  int distance_2 = urm07GetDistance(0x13);
  ...
  setNPSeg(((speed)>0?(speed):-(speed)), 10, 10, 0);
}
